import { BigintIsh, Token, validateAndParseAddress } from '@storyhunt/core'
import { MethodParameters, toHex } from './utils/calldata'
import { defaultAbiCoder, Interface } from '@ethersproject/abi'
import IStoryhuntV3Staker from './interfaces/IStoryHuntV3Staker.json'
...
export abstract class Staker {
  public static INTERFACE: Interface = new Interface(IStoryhuntV3Staker.abi)
