...
describe('#computePoolAddress', () => {
  ...
  it('should correctly compute the pool address', () => {
    const tokenA = new Token(1516, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', 18, 'USDC', 'USD Coin')
    const tokenB = new Token(1516, '0x6B175474E89094C44Da98b954EedeAC495271d0F', 18, 'DAI', 'DAI Stablecoin')
