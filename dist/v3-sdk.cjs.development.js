...
var CONSTANTS = _interopDefault(require('@storyhunt/default-list/build/storyhunt-default.constantlist.json'));
...
function computePoolAddress(_ref) {
  ...
  return address.getCreate2Address(deployerAddress, salt, initCodeHash);
}
...
var Pool = /*#__PURE__*/function () {
  ...
  Pool.getAddress = function getAddress(tokenA, tokenB, fee, initCodeHash, deployerAddress) {
  ...
  function Trade(_ref) {
    ...
    for (var _iterator = _createForOfIteratorHelperLoose(routes), _step; !(_step = _iterator()).done;) {
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(route.pools), _step2; !(_step2 = _iterator2()).done;) {
        ...
        poolAddressSet.add(pool.token0.address.toLowerCase() + "-" + pool.token1.address.toLowerCase() + "-" + pool.fee.toString());
      }
    }
...
Multicall.INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.NFT_POSITION_MANAGER_CONTRACT["interface"].abi);
...
SelfPermit.INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.SELF_PERMIT_CONTRACT["interface"].abi);
...
Payments.INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.PERIHERY_PAYMENT_WITH_FEE_CONTRACT["interface"].abi);
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.addCallParameters = function addCallParameters(position, options) {
    ...
    if (options.useNative) {
      ...
      !(position.pool.token0.equals(wrapped) || position.pool.token1.equals(wrapped)) ?  invariant(false, 'NO_WIP')  : void 0;
...
NonfungiblePositionManager.INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.NFT_POSITION_MANAGER_CONTRACT["interface"].abi);
...
var AlphaHunterV3 = /*#__PURE__*/function () {
  ...
  AlphaHunterV3.addCallParameters = function addCallParameters(position, options) {
    !(position.liquidity > ZERO) ?  invariant(false, 'ZERO_LIQUIDITY')  : void 0;
    var calldatas = [];
    // get amounts
    var _position$mintAmounts = position.mintAmounts,
      amount0Desired = _position$mintAmounts.amount0,
    ...
    var amount1Min = toHex(minimumAmounts.amount1);
    var deadline = toHex(options.deadline);
    !!isMint(options) ?  invariant(false, 'NO_MINT_SUPPORT')  : void 0;
    // permits if necessary
    if (options.token0Permit) {
      calldatas.push(SelfPermit.encodePermit(position.pool.token0, options.token0Permit));
    }
  ...
  AlphaHunterV3.encodeHarvest = function encodeHarvest(options) {
    ...
    var calldatas = [];
    // harvest pendingHunt
    calldatas.push(AlphaHunterV3.INTERFACE.encodeFunctionData('harvest', [toHex(tokenId), sdkCore.validateAndParseAddress(to)]));
    return calldatas;
  };
  AlphaHunterV3.withdrawCallParameters = function withdrawCallParameters(options) {
    ...
    var calldatas = [];
    // withdraw liquidity
    calldatas.push(AlphaHunterV3.INTERFACE.encodeFunctionData('withdraw', [toHex(tokenId), sdkCore.validateAndParseAddress(to)]));
    return {
      calldata: Multicall.encodeMulticall(calldatas),
      value: toHex(0)
    };
...
AlphaHunterV3.ABI = CONSTANTS.constants.interfaces.ALPHA_HUNTER_CONTRACT["interface"].abi;
AlphaHunterV3.INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.ALPHA_HUNTER_CONTRACT["interface"].abi);
...
SwapQuoter.V1INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.QUOTER_CONTRACT["interface"].abi);
SwapQuoter.V2INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.QUOTERV2_CONTRACT["interface"].abi);
      ...
      for (var _iterator2 = _createForOfIteratorHelperLoose(trade.swaps), _step2; !(_step2 = _iterator2()).done;) {
        ...
        if (!isNative) {
          if (tokens.map(function (_ref) {
            ...
            if (sampleTrade.tradeType === sdkCore.TradeType.EXACT_INPUT) {
              return;
            } else {
...
SwapRouter.INTERFACE = /*#__PURE__*/new abi.Interface(CONSTANTS.constants.interfaces.SWAP_ROUTER_CONTRACT["interface"].abi);

exports.ADDRESS_ZERO = ADDRESS_ZERO;
exports.AlphaHunterV3 = AlphaHunterV3;
